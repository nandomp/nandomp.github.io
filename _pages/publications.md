...
* Daniel Romero-Alvarado, **Fernando Martínez-Plumed**, José Hernández-Orallo [*What should an AI assessor optimise for?*](). [Machine Learning Journal] https://www.springer.com/journal/10994), Springer, To appear.
...
* Samuel Axel Zander-Marzano, José Hernández-Orallo, **Fernando Martínez-Plumed**, Pau Amores-Giner, Behzad Mehrbakhsh: [*"From Formal to Informal: How Register Shift Confuses LLMs in Spanish Dialect Recognition"*](), in [International Journal of Data Science and Analytics](https://link.springer.com/journal/41060), To appear.

* **Fernando Martínez-Plumed**, Cristina Padró-Ferragut, Mª José Ramírez-Quintana: [*"Targeted Robustness for Regression via Top-Feature Noise"*](), in Proceedings of the [European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases (ECML-PKDD 2026)](https://ecmlpkdd.org/2026/), Naples, Italy, September 7-11, 2026.

* Diego Vallejo-Huanga, Mateo Montenegro, Brenda Simbaña, Cèsar Ferri, **Fernando Martínez-Plumed**: [*"CapFlex: Multimodal Soft Clustering with Flexible Size Constraints"*](), in Proceedings of the [European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases (ECML-PKDD 2026)](https://ecmlpkdd.org/2026/), Naples, Italy, September 7-11, 2026. 

* Diego Vallejo-Huanga, Mateo Montenegro, Brenda Simbaña, Cèsar Ferri, **Fernando Martínez-Plumed**:  [Semi-Supervised Soft Clustering with Flexible Cardinality](https://icpr2026.org/acceptedPapers.html), International Conference on Pattern Recognition ([ICPR 2026](https://icpr2026.org/)), Lyon, France August, 17-22, 2026.
...
* **Fernando Mart&iacute;nez-Plumed**, Hern&aacute;ndez-Orallo: [*"Trabajos Finales de Grado y Máster orientados a investigación como caso de éxito"*](http://hdl.handle.net/10045/128967),  Jornadas sobre la Enseñanza Universitaria de la Informática (JENUI), A Coruña (Spain), June 2022.
